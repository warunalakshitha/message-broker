...
-- Start of Permission Store Tables --

CREATE TABLE MB_RESOURCE_PERMISSION (
                RESOURCE_NAME VARCHAR(256) NOT NULL,
                RESOURCE_GROUP_NAME VARCHAR(256) NOT NULL,
                USER_GROUP_ID VARCHAR(256) NOT NULL,
                PERMISSION INT,
                PRIMARY KEY (RESOURCE_NAME, RESOURCE_GROUP_NAME,USER_GROUP_ID)
);

CREATE TABLE MB_RESOURCE_GROUP_PERMISSION (
                RESOURCE_GROUP_NAME VARCHAR(256) NOT NULL,
                USER_GROUP_ID VARCHAR(256) NOT NULL,
                PERMISSION INT,
                PRIMARY KEY (RESOURCE_GROUP_NAME, USER_GROUP_ID)
);

INSERT INTO MB_RESOURCE_GROUP_PERMISSION (RESOURCE_GROUP_NAME, USER_GROUP_ID,PERMISSION)  VALUES('E','admin',15);
INSERT INTO MB_RESOURCE_GROUP_PERMISSION (RESOURCE_GROUP_NAME, USER_GROUP_ID,PERMISSION)  VALUES('B','admin',15);
INSERT INTO MB_RESOURCE_GROUP_PERMISSION (RESOURCE_GROUP_NAME, USER_GROUP_ID,PERMISSION)  VALUES('Q','admin',15);
