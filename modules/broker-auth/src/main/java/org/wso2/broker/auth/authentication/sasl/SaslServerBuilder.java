...
/**
 * Interface for build custom @{@link javax.security.sasl.SaslServer} for register auth mechanisms.
 */
public interface SaslServerBuilder {
    ...
    /**
     * This is used to store and provide auth information to authenticator
     *
