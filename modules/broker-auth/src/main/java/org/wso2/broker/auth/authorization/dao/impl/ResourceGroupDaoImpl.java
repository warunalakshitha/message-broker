...
public class ResourceGroupDaoImpl extends ResourceGroupDao {
    ...
    public Map<String, Integer> retrieve(String resourceGroup) throws BrokerAuthException {
        ...
        try {
            ...
            throw new BrokerAuthException("Error occurred while retrieving resource groups for give resource group: "
                                                  + resourceGroup, e);
        } finally {
    ...
    public Map<String, Map<String, Integer>> readAll() throws BrokerAuthException {
        ...
        try {
            ...
            throw new BrokerAuthException("Error occurred while retrieving resource groups", e);
        } finally {
            close(connection, statement, resultSet);
        }
