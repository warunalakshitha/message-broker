...
public class ResourceDaoTest {
    ...
    @Test(priority = 2,
          ...
          expectedExceptionsMessageRegExp = ".*Error persisting permissions.*")
    ...
    public void testNewPersist() throws Exception {
        ...
        Assert.assertEquals(permissions.get(PLAYER_ROLE).intValue(), 1,
                            "Player role permissions are incorrect");
    }
