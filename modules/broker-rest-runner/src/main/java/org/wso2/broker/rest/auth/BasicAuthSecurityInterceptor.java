...
/**
 * Class implements @{@link AbstractBasicAuthSecurityInterceptor} to authenticate requests based on basic auth header.
 */
public class BasicAuthSecurityInterceptor extends AbstractBasicAuthSecurityInterceptor {
    ...
    protected boolean authenticate(String userName, String password) {
        try {
            return userName != null && password != null && authenticateFunction.authenticate(userName, password
                    .toCharArray());
        } catch (Exception e) {
